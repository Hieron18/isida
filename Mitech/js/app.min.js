...
let slider_about = new Swiper('.header__wrapper', {
	// effect: 'fade',
	autoplay: {
		delay: 2000,
...
const plan = document.querySelector(".header__plan");
const bod = document.querySelector("body");
const other = document.querySelector(".fa-ellipsis-h");
if(Menuicon){
   const menuBody = document.querySelector('.menu__body');
   Menuicon.addEventListener('click', function(e) {
      Menuicon.classList.toggle('_active');
      menuBody.classList.toggle('_active');
      plan.classList.toggle('_active');
      bod.classList.toggle('_lock');
   })
}
const rels = document.querySelector(".header__many_rels");
if(other){
   other.addEventListener('click', function(){
      if(rels.classList.contains('_active')){
         rels.classList.remove('_active')
      }else{
         rels.classList.add('_active')
      }
   })
}
